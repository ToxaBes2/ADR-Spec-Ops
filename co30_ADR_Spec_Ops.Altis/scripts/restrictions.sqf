...
//===== UAV TERMINAL
_uavOperator = ["B_engineer_F","I_G_Soldier_M_F","I_G_engineer_F"];
_uavRestricted = ["B_UavTerminal","O_UavTerminal","I_UavTerminal"];
//===== AT / MISSILE LAUNCHERS
_missileSoldiers = ["B_soldier_AT_F","I_G_Soldier_M_F","I_G_Soldier_AR_F"];
...
_missileSmallSoldiers = ["B_soldier_AT_F","B_Soldier_SL_F","I_G_Soldier_M_F","I_G_Soldier_AR_F"];
_missileSmallSpecialised = ["launch_RPG32_F","launch_NLAW_F"];
//===== SNIPER RIFLES
_snipers = ["B_sniper_F","I_G_Soldier_M_F","I_G_engineer_F"];
...
//=== GRENADIERS
_grenadier = ["B_Soldier_SL_F","B_medic_F","B_engineer_F","I_G_Soldier_M_F","I_G_Soldier_AR_F","I_G_Soldier_M_F","I_G_engineer_F"];
...
//=== COMMANDERS
_commanders = ["B_Soldier_SL_F","I_G_Soldier_M_F","I_G_Soldier_AR_F","I_G_Soldier_M_F","I_G_engineer_F"];
_commanderItems = ["Laserdesignator","Laserdesignator_02","Laserdesignator_03"];
//===== THERMAL
_ThermalTeam = ["b_g_survivor_F"];
_ThermalOpt = ["optic_Nightstalker","optic_tws","optic_tws_mg"];

//===== MARKSMAN OPTICS
_marksmanOpticsGrp = ["B_sniper_F","B_soldier_M_F","I_G_Soldier_M_F","I_G_Soldier_AR_F","I_G_Soldier_M_F","I_G_engineer_F"];
