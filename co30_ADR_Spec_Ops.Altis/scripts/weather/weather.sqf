...
if (_hour in _hours) then {
    if (PARAMS_Weather == 1) then {
        ...
        try {
            ...
            ["setWeather",[0, '"overcast"', _data select 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"rain"', _data select 1], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fog"', _data select 2], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fogDecay"', _data select 3], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fogBase"', _data select 4], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"waves"', _waves], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind"', _wind], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_gusts"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_dir"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_real"', _wind], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"lightning"', _data select 8], 0] remoteExec ["sqlServerCall", 2];
        } catch {};
    } else {
        ["getWeather",[0], 0] remoteExec ["sqlServerCall", 2];
    };
} else {
    if (_hour == 20) then {
        ...
        try {
            ["clearWeather",[], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"overcast"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"rain"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fog"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fogDecay"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"fogBase"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"waves"', _rand], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind"', _rand], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_gusts"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_dir"', 0], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"wind_real"', _rand], 0] remoteExec ["sqlServerCall", 2];
            ["setWeather",[0, '"lightning"', 0], 0] remoteExec ["sqlServerCall", 2];
        } catch {};
    };
};
