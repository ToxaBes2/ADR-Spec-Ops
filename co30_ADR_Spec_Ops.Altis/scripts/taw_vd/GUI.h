...
class TAWVD_RscControlsGroup {
	...
	//class ListScrollBar2 : ScrollBar {};
	
	class Controls {};
};

class TAWVD_RscControlsGroupNoScrollbars : TAWVD_RscControlsGroup {
...
class TAW_VDMenu {
	...
	class controlsBackground {
		class TitleBackground : TAWVD_RscText {
		...
		class OnFootText : TAWVD_RscText {
			idc = -1;
			text = "Пешком";
			x = .32;
			y = .258;
	...
	class controls {
		...
		class VD_onFoot_Edit : TAWVD_RscEdit {
			idc = INFANTRY_EDIT;
			text = "";
		...
		class ObjectSyncCheckbox : TAWVD_RscCheckbox
		{
			idc = 2931;
			x = .32; y = .6;
		...
		class Manager:TAWVD_RscControlsGroup {
			idc = MANAGER_GROUP;
			
			x = -0.21; y = .2;
			w = .5; h = 3;
			class Controls {
				class SaveLoadGroup:TAWVD_RscControlsGroupNoScrollbars {
					idc = SAVELOAD_GROUP;
					...
					class Controls {
						class MyTitleBackground:TAWVD_RscText {
							colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
							idc = -1;
							x = 0;
							y = 0;
						...
						class SaveList:TAWVD_RscListBox {
							idc = SAVES_LIST;
							sizeEx = 0.04;
						...
						class SaveButton:TAWVD_RscButtonMenu {
							text = "Сохранить";
						...
						class HideButton:TAWVD_RscButtonMenu {
							text = "Спрятать";
