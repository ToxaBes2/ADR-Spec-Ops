...
if (_c < 3) then {
	doStop _unit;
    [_unit,(["WATCH","WATCH1","WATCH2"] call BIS_fnc_selectRandom),"FULL", {!isNull (_unit findNearestEnemy (getPos _unit)) || lifestate _unit == "INJURED"}, "COMBAT"] call BIS_fnc_ambientAnimCombat;
} else {
