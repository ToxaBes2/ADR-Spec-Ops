...
_rewardsEndlessGame = [
    ["Отряд Viper", ['configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "SpecOps" >> "OI_ViperTeam"']],
    ["Отделение тяжелого оружия", ['configfile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfSquad_Weapons"']]
];
