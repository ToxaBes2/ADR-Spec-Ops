...
// SNIPER RIFLES
_snipers = ["I_G_engineer_F","I_C_Soldier_Para_8_F"];
...
// LMG
_autoRiflemen = ["I_G_Soldier_AR_F","I_C_Soldier_Para_4_F","I_G_medic_F"];
...
// MARKSMAN
_marksman = ["I_G_engineer_F","I_C_Soldier_Para_8_F"];
...
// MARKSMAN OPTICS
_marksmanOpticsGrp = ["I_G_Soldier_AR_F","I_G_engineer_F","I_G_medic_F","I_G_Soldier_GL_F"];
