...
while {alive radioTower || !MAIN_AO_SUCCESS || !_showTowerMessage || !_showBunkerMessage} do {
    ...
    if ((MAIN_AO_SUCCESS and !_viperSquadSpawned) or (!alive radioTower and !_viperSquadSpawned)) then {
        ...
        if (random 1 > 0.5) then {
            _enemiesArray pushBack ([(_bunkerPos getPos [(_bunkerPos distance2D _flatPos) / 2, _bunkerPos getDir _flatPos]), 500, 500, 3000, true, ENEMY_SIDE] call QS_fnc_spawnViper);
        };
    };
};
...
"O_T_Crew_F","O_T_Diver_Exp_F","O_T_Diver_F","O_T_Diver_TL_F","O_T_Engineer_F","O_T_Helicrew_F","O_T_Helipilot_F","O_T_Medic_F",
"O_T_Officer_F","O_T_Pilot_F","O_T_Recon_Exp_F","O_T_Recon_F","O_T_Recon_JTAC_F","O_T_Recon_LAT_F","O_T_Recon_M_F","O_T_Recon_Medic_F",
"O_T_Recon_TL_F","O_T_Sniper_F","O_T_Soldier_AAA_F","O_T_Soldier_AAR_F","O_T_Soldier_AAT_F","O_T_Soldier_AA_F","O_T_Soldier_AR_F",
"O_T_Soldier_AT_F","O_T_Soldier_A_F","O_T_Soldier_Exp_F","O_T_Soldier_F","O_T_Soldier_GL_F","O_T_Soldier_LAT_F","O_T_Soldier_M_F",
"O_T_Soldier_PG_F","O_T_Soldier_Repair_F","O_T_Soldier_SL_F","O_T_Soldier_TL_F","O_T_Soldier_UAV_F","O_T_Spotter_F","O_T_Support_AMG_F",
"O_T_Support_AMort_F","O_T_Support_GMG_F","O_T_Support_MG_F","O_T_Support_Mort_F","O_T_ghillie_tna_F","O_V_Soldier_Exp_ghex_F",
"O_V_Soldier_JTAC_ghex_F","O_V_Soldier_LAT_ghex_F","O_V_Soldier_M_ghex_F","O_V_Soldier_Medic_ghex_F","O_V_Soldier_TL_ghex_F","O_V_Soldier_ghex_F"];
