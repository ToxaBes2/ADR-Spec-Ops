...
_compositions = [
    [
        ...
        ["O_HMG_01_high_F",[-8.97656,-13.4102,-0.113056],180.005,1,0,[-0.314765,-0.00208143],"","",true,false], 
    ...
    [
        ...
        ["B_GMG_01_high_F",[-3.03906,5.25195,-0.111811],359.999,1,0,[0.000374051,6.23374e-005],"","",true,false], 
...
_res = count _flatPos;
while {_res == 0} do {
    _pos = [_centerPos, 0, 600, 15, 0, 4, 0, [] call QS_fnc_findSafePos;
    _res = count _flatPos;
};
