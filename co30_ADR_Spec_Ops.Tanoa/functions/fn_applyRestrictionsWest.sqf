...
_missileSpecialised = ["launch_Titan_short_F","launch_Titan_F","launch_B_Titan_F","launch_O_Titan_F","launch_I_Titan_F","launch_B_Titan_short_F","launch_O_Titan_short_F","launch_I_Titan_short_F","launch_B_Titan_tna_F","launch_B_Titan_short_tna_F","launch_O_Titan_ghex_F","launch_O_Titan_short_ghex_F","launch_O_Vorona_green_F"];

// SMALL MISSILE LAUNCHERS
_missileSmallSoldiers = ["B_soldier_AT_F","B_T_Soldier_AT_F","B_Soldier_SL_F","B_T_Soldier_SL_F"];
_missileSmallSpecialised = ["launch_RPG32_F","launch_NLAW_F","launch_RPG32_ghex_F","launch_RPG7_F","launch_MRAWS_green_rail_F","launch_MRAWS_olive_rail_F","launch_MRAWS_green_F","launch_MRAWS_olive_F"];
...
"U_B_T_FullGhillie_tna_F","U_B_T_Sniper_F","U_B_T_Soldier_AR_F","U_B_T_Soldier_F","U_B_T_Soldier_SL_F"];

// BACKPACKS
_allowedBackpacks = ["B_AssaultPack","B_AssaultPackG","B_AssaultPack_blk","B_AssaultPack_rgr","B_AssaultPack_sgg","B_Bergen_blk","B_Bergen_rgr","B_Bergen_sgg",
...
"B_ViperHarness_blk_F","B_ViperHarness_oli_F","B_ViperLightHarness_blk_F","B_ViperLightHarness_oli_F","B_Kitbag_rgr_BTAT_F","B_Kitbag_rgr_BTEng_F",
"B_AssaultPack_tna_BTMedic_F","I_GMG_01_A_weapon_F","O_GMG_01_A_weapon_F","I_GMG_01_high_weapon_F","O_GMG_01_high_weapon_F","I_GMG_01_weapon_F",
"O_GMG_01_weapon_F","I_HMG_01_high_weapon_F","O_HMG_01_high_weapon_F","I_HMG_01_weapon_F","O_HMG_01_weapon_F","I_HMG_01_A_weapon_F","O_HMG_01_A_weapon_F",
"I_Mortar_01_support_F","O_Mortar_01_support_F","I_HMG_01_support_high_F","O_HMG_01_support_high_F","I_HMG_01_support_F","O_HMG_01_support_F","I_Mortar_01_weapon_F",
"O_Mortar_01_weapon_F","I_AA_01_weapon_F","O_AA_01_weapon_F","I_AT_01_weapon_F","O_AT_01_weapon_F","O_Static_Designator_02_weapon_F"];
...
"V_PlateCarrier1_rgr","V_PlateCarrier2_rgr","V_PlateCarrier3_rgr","V_PlateCarrierGL_blk","V_PlateCarrierGL_rgr","V_PlateCarrierH_CTRG",
"V_PlateCarrierL_CTRG","V_PlateCarrierSpec_blk","V_PlateCarrierSpec_rgr","V_Rangemaster_belt","V_RebreatherB",
"V_TacVestCamo_khk","V_TacVestIR_blk","V_TacVest_blk","V_TacVest_oli","V_PlateCarrier1_rgr_noflag_F","V_PlateCarrier1_tna_F",
"V_PlateCarrier2_rgr_noflag_F","V_PlateCarrierGL_blk","V_PlateCarrierGL_tna_F","V_PlateCarrierSpec_tna_F","V_TacChestrig_grn_F",
"V_TacChestrig_oli_F","V_PlateCarrierIAGL_oli","V_PlateCarrier2_tna_F"];

// HEADGEAR
_allowedHeadgear = ["H_BandMask_demon","H_BandMask_khk","H_BandMask_reaper","H_Booniehat_dirty","H_Booniehat_grn","H_Booniehat_indp","H_CrewHelmetHeli_B",
"H_HelmetB_light","H_HelmetB_paint","H_HelmetB_plain_blk","H_HelmetCrew_B","H_Helmet_Kerry","H_PilotHelmetFighter_B","H_PilotHelmetHeli_B",
...
"arifle_SPAR_03_blk_F","arifle_SPAR_03_blk_F","arifle_MXC_khk_F","arifle_MXM_khk_F","arifle_MX_GL_khk_F","arifle_MX_SW_khk_F","arifle_MX_khk_F","launch_MRAWS_green_rail_F","launch_MRAWS_olive_rail_F","launch_MRAWS_green_F","launch_MRAWS_olive_F"];
...
"arifle_CTARS_blk_F","arifle_CTAR_blk_F","arifle_CTAR_GL_blk_F","launch_RPG32_ghex_F","launch_O_Vorona_green_F","SMG_02_F"];
            _indWList = ["LMG_03_F","launch_RPG7_F","arifle_AK12_F","arifle_AKM_F","arifle_AKS_F","arifle_AK12_GL_F","SMG_05_F"];
