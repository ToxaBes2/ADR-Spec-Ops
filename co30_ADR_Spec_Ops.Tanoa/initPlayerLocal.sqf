...
if (typeOf player in ["B_T_Engineer_F", "I_C_Soldier_Para_8_F"]) then {
	_null = [] spawn {
		...
		while {true} do {
			if ((typeOf cameraOn) in ["B_UAV_01_F","B_UAV_02_F","B_UAV_05_F","B_UAV_02_CAS_F","B_UGV_01_F","B_UGV_01_rcws_F","I_UAV_01_F","I_UAV_02_F","I_UAV_02_CAS_F","I_UGV_01_F","I_UGV_01_rcws_F","O_UAV_01_F","O_UAV_02_F","O_UAV_02_CAS_F","O_UGV_01_F","O_UGV_01_rcws_F","B_T_UAV_03_F","O_T_UAV_04_CAS_F"]) then {
				_uav = cameraOn;
				1 fadeSound 0.33;
