if (hasInterface) then {
	...
	"O_UAV_01_F","O_UAV_02_F","O_UAV_02_CAS_F","O_UGV_01_F","O_UGV_01_rcws_F","B_T_UAV_03_F","O_T_UAV_04_CAS_F","B_UAV_02_dynamicLoadout_F","B_T_UAV_03_dynamicLoadout_F","B_UAV_06_F","I_UAV_06_F"];
	while {true} do {
