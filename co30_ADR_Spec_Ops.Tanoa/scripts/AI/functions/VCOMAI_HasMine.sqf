private ["_Unit", "_Magazine", "_value", "_SubtractAmount", "_DemoCharge", "_SatchelCharge", "_Bomb", "_IsWired", "_IsRemote", "_IsClaymore", "_MineName","_VCOM_HASSATCHEL"];
...
_Vcom_MineObject = false;
_Vcom_MineObjectMagazine = false;

if !(isNil "_magazinesAmmo") then {
    if (count _magazinesAmmo > 0) then {
        {
