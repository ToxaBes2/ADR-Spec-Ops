...
BTC_who_can_revive  = ["B_medic_F","I_G_Soldier_AR_F","I_G_engineer_F","I_C_Soldier_Para_3_F","I_C_Soldier_Para_7_F"];
BTC_loop_check      = 1;
...
BTC_3d_can_see     = ["B_medic_F","I_G_Soldier_AR_F","I_G_engineer_F","I_C_Soldier_Para_3_F","I_C_Soldier_Para_7_F"];
BTC_3d_distance    = 800;
