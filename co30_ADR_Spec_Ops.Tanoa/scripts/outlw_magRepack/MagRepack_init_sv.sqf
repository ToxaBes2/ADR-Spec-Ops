...
[] spawn {_this call compile preProcessFileLineNumbers "scripts\outlw_magRepack\Scripts\MagRepack_Main.sqf"};
[] spawn {_this call compile preProcessFileLineNumbers "scripts\outlw_magRepack\Scripts\MagRepack_Keybindings.sqf"};
[] spawn {_this call compile preProcessFileLineNumbers "scripts\outlw_magRepack\Scripts\MagRepack_Misc.sqf"};
