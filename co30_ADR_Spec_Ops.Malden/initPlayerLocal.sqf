...
if (typeOf player in ["B_engineer_F", "I_G_engineer_F"]) then {
	_null = [] spawn {
		...
		while {true} do {
			if ((typeOf cameraOn) in ["B_UAV_01_F","B_UGV_01_F","B_UGV_01_rcws_F","B_UAV_05_F","I_UAV_01_F","I_UAV_02_F","I_UAV_02_CAS_F","I_UGV_01_F","I_UGV_01_rcws_F","O_UAV_01_F","O_UAV_02_F","O_UAV_02_CAS_F","O_UGV_01_F","O_UGV_01_rcws_F","B_T_UAV_03_F","O_T_UAV_04_CAS_F","B_T_UAV_03_dynamicLoadout_F","B_UAV_02_dynamicLoadout_F"]) then {
				_uav = cameraOn;
				1 fadeSound 0.25;
