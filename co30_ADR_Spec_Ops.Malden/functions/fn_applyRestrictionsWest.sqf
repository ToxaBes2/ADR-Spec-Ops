...
if (isClass(configfile >> "CfgPatches" >> "SMA_Weapons")) then {   
    ...
    "arifle_SPAR_02_blk_F","arifle_SPAR_01_snd_F","arifle_SPAR_01_blk_F","arifle_SPAR_01_GL_snd_F","arifle_SPAR_01_GL_blk_F","launch_MRAWS_olive_rail_F","launch_MRAWS_sand_rail_F","launch_MRAWS_olive_F","launch_MRAWS_sand_F"];
