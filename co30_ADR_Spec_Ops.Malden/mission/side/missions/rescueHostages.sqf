...
_targets = [
    ["Заброшенная Военная База",         [6100.05,10761.3]],
    ["Морэй",                            [920.701,11937.6]], 
    ["Сент-Лиус",                        [7130.39,8962.39]],
    ["Ларше",                            [6047.04,8636.42]],
    ["Гуис",                             [3636.92,8688.72]],
    ["Эради",                            [5504.35,7010.48]],
    ["Ла Трините",                       [7275.07,7862.97]],
    ["Хаудан",                           [7374.96,6050.29]],
    ["Ла Пессане",                       [3103.38,6308.96]],
    ["Шапой",                            [5964.18,3516.45]],
    ["Доррес",                           [4940.47,4788.73]],
    ["Порт",                             [7982.51,3589.69]],
    ["Ла Ривьер",                        [3819.76,3342.93]],
    ["Военная База",                     [9744.83,3797.29]]
];
...
// set Cargo HQ
_cargoPos = [_startPoint, 0, 85, 3, 0, 15, 0, [], [_startPoint]] call QS_fnc_findSafePos;
    ...
    if (!_viperSquadSpawned) then {
        if ((!alive officer) or (SM_FAIL_RESCUE > 0) or (SM_SUCCESS_RESCUE > 0)) then {
            ...
            if (random 1 > 0.5) then {
                _enemiesArray pushBack ([(getPos _cargoHQ), 500, 500, 3000, false, ENEMY_SIDE] call QS_fnc_spawnViper);
            };
        };
    };
    sleep 1;
